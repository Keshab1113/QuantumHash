...
const customStyles = {
  control: (provided, state) => ({
    ...
    borderRadius: "10px",
    fontSize: state.selectProps.myFontSize || "14px",
    color: "#000000",
    padding: "4px 10px",
    minHeight: "40px",
    overflow: "visible", // allow dropdown arrow without scroll issues
  }),
...
const Meeting = () => {
  ...
  return (
    <section className="w-full">
      <h1 className="md:text-[38px] text-[28px] font-bold h1head1 mt-10 text-center w-fit mx-auto">
        Schedule A Meeting
      </h1>
      <h2 className="text-base font-normal text-white mt-1 text-center">
        Meet With Our Quantumhash Team
      </h2>
      {isConfirmed ? (
        <div className="w-full flex items-center justify-center mt-20">
          <div className="bg-white p-10 rounded-xl text-center shadow-lg w-full max-w-sm">
            <img
              ...
              loading="lazy"
            />
            <h1 className="text-xl font-bold text-[#0d0125] mb-2">
              Meeting confirmed
            </h1>
            <p className="text-sm text-gray-700 mb-4">
              You're booked a Meeting with Quantumhash Team.
              <br />
          ...
          >
            ...
            <div className=" mt-6 bg-white rounded-2xl p-4">
              ...
              <p className=" text-sm mt-2">
                ...
                key technical challenges, and learn how QuantumHash’s innovative
                solutions can accelerate your product, streamline operations,
                and drive results across your business.
              </p>
            </div>
          </div>
            ...
            >
              <div>
                ...
                <h2 className="text-[12px] ">
                  {value.toDateString()} - {selectedTime} | Duration: {duration}{" "}
                  minutes | {timezone}
                </h2>
              </div>
              <div>
            ...
            <div className="border border-white border-solid rounded-2xl lg:w-[55%] w-full p-6 py-10 text-white">
              <div className="mb-5">
                ...
                <input
                  ...
                  className="w-full py-[10px] px-3 rounded-xl text-black bg-white outline-0"
                />
              </div>
