...
// import AIMovingAnimation from "./AIChipAnimation";
// ("./AIMovingAnimation");
...
//         <h1 className=" md:text-[38px] text-[28px] font-bold text-white max-w-[90%] mb-10">
...
//        <div
//   className="md:w-[60%] w-full text-white mt-5 pt-5 pb-20 font-sans"
//   style={{
//     backgroundImage: "url('/Images/InnovationBG.png')",
//     backgroundSize: "cover",
//   }}
// >
//   <ul className="space-y-6 md:max-w-[90%]">
//     {[
...
//         <span
//           className="flex-shrink-0 w-4 h-4 mt-1 rounded-full bg-gradient-to-br from-orange-400 via-pink-500 to-purple-700 animate-pulse"
//         ></span>
//         <p className="text-lg md:text-base leading-relaxed font-medium">
//           {text}
//         </p>
//       </li>
//     ))}
...
//   <Link to={"about"}>
//     <button className="text-white border border-white cursor-pointer py-2 px-6 rounded-full mt-10 font-medium hover:bg-white hover:text-black transition-all duration-300">
//       Explore More
//     </button>
//   </Link>
// </div>
...
//                     intelligence core behind all our platforms, capable of
//                     understanding context, voice input, and domain-specific
//                     tasks — from safety compliance to student tutoring.
//                   </p>
//                   <h1 className=" text-center h1head1 mt-2 text-xl font-bold">
//                     QuantumAI
//                   </h1>
//                 </div>
//               </Card>
...
//                     in 3D, and guide proactive decision-making. Trusted by HSE
//                     leaders for safety awareness, audits, and operational
//                     excellence.
//                   </p>
//                   <h1 className=" text-center h1head1 mt-2 text-xl font-bold">
//                     ASES (Advanced Safety & Efficiency System)
//                   </h1>
//                 </div>
//               </Card>
//               <Card>
...
//                     voice, emotion, and attention analysis. The platform adapts
//                     to each student’s learning speed, focus, and subject
//                     preferences to make education deeply personal.
//                   </p>
//                   <h1 className=" text-center h1head1 mt-2 text-xl font-bold">
//                     QuantumEdu
//                   </h1>
...
//                   <div className="h-[20vh] lg:w-[34vw] w-full max-w-[100%] rounded-2xl bg-white mb-4 overflow-hidden">
//                     <img
//                       src="/Projects/assesment.PNG" // replace with your MOM image
//                       alt="Office MOM - Moments of the Meeting"
//                       className="w-full h-full object-fill"
//                       loading="lazy"
//                     />
//                   </div>
...
//                     items. Office MOM ensures that every meeting is productive,
//                     collaborative, and easy to follow up—making team
...
//                   <div className="h-[20vh] lg:w-[34vw] w-full max-w-[100%] rounded-2xl bg-white mb-4 overflow-hidden">
//                     <img
//                       src="/Projects/officemom.PNG" // replace with your MOM image
//                       alt="Office MOM - Moments of the Meeting"
//                       className="w-full h-full object-fill"
//                       loading="lazy"
//                     />
